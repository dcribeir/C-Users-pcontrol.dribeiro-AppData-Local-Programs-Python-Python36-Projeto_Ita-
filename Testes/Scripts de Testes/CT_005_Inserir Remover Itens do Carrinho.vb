...
Namespace test_Digital_Inserir_Remover_Itens_do_Carrinho
    Public Class test_Digital_Inserir_Remover_Itens_do_Carrinho
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                    ...
                    Do While p_CountTest <> 0
                        Try
                            If CBool(vIsOpenSystem) Then 'if true open system else load new test without open system
								...
								Test.TestLog("Acessar o sistema Digital", "Sistema deve apresentar a funcionalidadeInserir/Remover Itens do Carrinho", "Sistema apresentou a funcionalidade Inserir/Remover Itens do Carrinho com sucesso", typelog.Passed)
							End If
							...
							End If
							If CBool(vbtnRemover_produto) Then
								Test.TestLog("Clicar em Remover produto", "Clicar em Remover produto e verificar o resultado esperado", "Clique em Remover produto com sucesso", typelog.Passed)
								Test.Click("form-0-DELETE", vbtnRemover_produto, typeIdentification.name) 'click Remover produto
								Test.TestLog("Resultado após clique em Remover produto", "Resultado após clique em Remover produto", "Resultado verificado com sucesso", typelog.Passed)
							End If
							If CBool(vbtnAtualizar) Then
								Test.TestLog("Clicar em Atualizar", "Clicar em Atualizar e verificar o resultado esperado", "Clique em Atualizar com sucesso", typelog.Passed)
								Test.Click("button", vbtnAtualizar, typeIdentification.name) 'click Atualizar
								Test.TestLog("Resultado após clique em Atualizar", "Resultado após clique em Atualizar", "Resultado verificado com sucesso", typelog.Passed)
							End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Digital_Inserir_Remover_Itens_do_Carrinho.test_Digital_Inserir_Remover_Itens_do_Carrinho.Run: " & ex.Message)
        ...
        Public Shared vbtnEntrar,vUsuario, vSenha, vbtnLogar,vbtnProduto,vbtnAdicionar_produto,vbtnContinuar_comprando,vbtnAdicionar_produto_1,vbtnRemover_produto,vbtnAtualizar, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vbtnRemover_produto = pc_db.Fieldt("vbtnRemover_produto")
					vbtnAtualizar = pc_db.Fieldt("vbtnAtualizar")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Digital_Inserir_Remover_Itens_do_Carrinho.test_Digital_Inserir_Remover_Itens_do_Carrinho.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
