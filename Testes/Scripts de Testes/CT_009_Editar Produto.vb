...
Namespace test_Digital_Editar_Produto
    Public Class test_Digital_Editar_Produto
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                    ...
                    Do While p_CountTest <> 0
                        Try
                            If CBool(vIsOpenSystem) Then 'if true open system else load new test without open system
								...
								Test.TestLog("Acessar o sistema Digital", "Sistema deve apresentar a funcionalidadeEditar Produto", "Sistema apresentou a funcionalidade Editar Produto com sucesso", typelog.Passed)
							End If
							...
							End If
							Test.TestLog("Informar valores", "Sistema deve solicitar os valores conforme critérios de entrada", "Sistema permitiu a inclusão de valores com sucesso", typelog.Passed)
							Test.Set("q", vInformar_produto_1,"", typeIdentification.name) 'type Informar produto_1
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Digital_Editar_Produto.test_Digital_Editar_Produto.Run: " & ex.Message)
        ...
        Public Shared vUsuario, vSenha, vbtnLogar,vbtnProduto,vInformar_produto, vbtnPesquisar,vbtnProduto_1,vIdentificador, vbtnSalvar,vInformar_produto_1, vbtnPesquisar_1, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vInformar_produto_1 = pc_db.Fieldt("vInformar_produto_1")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Digital_Editar_Produto.test_Digital_Editar_Produto.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
