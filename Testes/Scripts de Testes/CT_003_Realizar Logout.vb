...
Namespace test_Digital_Realizar_Logout
    Public Class test_Digital_Realizar_Logout
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                    ...
                    Do While p_CountTest <> 0
                        Try
                            If CBool(vIsOpenSystem) Then 'if true open system else load new test without open system
								...
								Test.TestLog("Acessar o sistema Digital", "Sistema deve apresentar a funcionalidadeRealizar Logout", "Sistema apresentou a funcionalidade Realizar Logout com sucesso", typelog.Passed)
							End If
							...
							End If
							If CBool(vbtnSair) Then
								Test.TestLog("Clicar em Sair", "Clicar em Sair e verificar o resultado esperado", "Clique em Sair com sucesso", typelog.Passed)
								Test.Click("//*[@id='navbar-main']/ul[2]/li[3]/a", vbtnSair) 'click Sair
								Test.TestLog("Resultado após clique em Sair", "Resultado após clique em Sair", "Resultado verificado com sucesso", typelog.Passed)
							End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Digital_Realizar_Logout.test_Digital_Realizar_Logout.Run: " & ex.Message)
        ...
        Public Shared vbtnEntrar,vUsuario, vSenha, vbtnLogar,vbtnConta,vbtnSair, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vbtnSair = pc_db.Fieldt("vbtnSair")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Digital_Realizar_Logout.test_Digital_Realizar_Logout.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
