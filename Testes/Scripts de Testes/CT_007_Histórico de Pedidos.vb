...
Namespace test_Digital_Historico_de_Pedidos
    Public Class test_Digital_Historico_de_Pedidos
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
                    ...
                    Do While p_CountTest <> 0
                        Try
                            If CBool(vIsOpenSystem) Then 'if true open system else load new test without open system
								...
								Test.TestLog("Acessar o sistema Digital", "Sistema deve apresentar a funcionalidadeHistórico de Pedidos", "Sistema apresentou a funcionalidade Histórico de Pedidos com sucesso", typelog.Passed)
							End If
							...
							End If
							If CBool(vbtnPedidos) Then
								Test.TestLog("Clicar em Pedidos", "Clicar em Pedidos e verificar o resultado esperado", "Clique em Pedidos com sucesso", typelog.Passed)
								Test.Click("/html/body/div[2]/div/div[1]/div/a[4]", vbtnPedidos) 'click Pedidos
								Test.TestLog("Resultado após clique em Pedidos", "Resultado após clique em Pedidos", "Resultado verificado com sucesso", typelog.Passed)
							End If
							Test.GetTextAndSave("Histórico de Pedidos", "vValidar_out", typeIdentification.linkText) 'GetTextAndSave Validar
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_Digital_Historico_de_Pedidos.test_Digital_Historico_de_Pedidos.Run: " & ex.Message)
        ...
        Public Shared vbtnEntrar,vUsuario, vSenha, vbtnLogar,vbtnConta,vbtnPedidos, vIsOpenSystem As String
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                If p_CountTest <> 0 Then
					...
					vbtnPedidos = pc_db.Fieldt("vbtnPedidos")
                ...
                End If
            Catch ex As Exception
                HandlerError("test_Digital_Historico_de_Pedidos.test_Digital_Historico_de_Pedidos.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
